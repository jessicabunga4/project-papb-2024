...
public class AddProduct extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String FirebaseURL = "https://profile-2bf5c-default-rtdb.firebaseio.com/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_product); // Layout XML untuk AddProduct
        ...
        this.appDb = this.db.getReference("products"); // Reference untuk produk
            ...
            this.appDb.child(id).setValue(product).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(AddProduct.this, "Gagal menambahkan produk. Coba lagi.", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private void loadProductsFromFirebase() {
        appDb.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AddProduct.this, "Gagal memuat data: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
