package jess.pam.progress1before;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail); // Ubah nama layout jika perlu
        ...
        backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish(); // Menutup DetailActivity dan kembali ke Activity sebelumnya
            }
        });

        // Ambil data dari intent dan tampilkan di view
